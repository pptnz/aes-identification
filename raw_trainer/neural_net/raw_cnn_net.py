...
w4 = tf.get_variable(name='w4', shape=[5, 5, 8, 16], initializer=tf.contrib.keras.initializers.he_normal())
...
w5 = tf.get_variable(name='w5', shape=[5, 5, 16, 32], initializer=tf.contrib.keras.initializers.he_normal())
...
w6 = tf.get_variable(name='w6', shape=[128, 16], initializer=tf.contrib.keras.initializers.he_normal())
