...
plain_train_reader = tf.FixedLengthRecordReader(record_bytes=input_dimension)
encrypted_train_reader = tf.FixedLengthRecordReader(record_bytes=input_dimension)

plain_validation_reader = tf.FixedLengthRecordReader(record_bytes=input_dimension)
encrypted_validation_reader = tf.FixedLengthRecordReader(record_bytes=input_dimension)

plain_test_reader = tf.FixedLengthRecordReader(record_bytes=input_dimension)
encrypted_test_reader = tf.FixedLengthRecordReader(record_bytes=input_dimension)
